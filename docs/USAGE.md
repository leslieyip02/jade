...
The documentation site combines the Markdown files in `docs/` with the HTML
API reference generated by Dokka. Install the site dependencies and build the
combined site with:
...
```sh
./scripts/build-docs.sh /tmp/jade-docs-site
```
